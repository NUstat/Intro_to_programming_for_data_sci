...
Create and print a 9x9 matrix that contains the number of times the function calls itself to try a digit for the respective cell in the puzzle.

*(5 points)*

### Reducing recursive calls

Analyze the matrix created in the previous question. Edit the function to reduce the number of recursive calls to solve the puzzle. Your approach must be general and not specific to this particular puzzle. 
