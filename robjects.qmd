...
Execute the following code to obtain the objects `coordinates_capital_cities` and `country_names`. Make sure the file *capital_cities.csv* is in your current working directory.
