...
- The table of contents appears in the file (1)

- The final answer on code execution is clearly printed out. The graders don't need to execute your code to check the answer  (1.5 points).
