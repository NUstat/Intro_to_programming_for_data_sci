...
The streaming platforms used by the students of two sections of the course STAT303-1 are give below as two atomic vectors - `streaming_platform_section1` and `streaming_platform_section2`
